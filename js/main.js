...
// Чтобы временно заблокировать прокрутку, установите scrollEnabled в false
function disableScroll() {
  scrollEnabled = false;
  body.style.overflow = "hidden";
}

// Чтобы разрешить прокрутку, установите scrollEnabled в true
function enableScroll() {
  scrollEnabled = true;
  body.style.overflow = "auto";
}
// Блокируем скроллинг при взаимодействии с изображением
zoomContainer.addEventListener("touchstart", disableScroll, false);

// Разблокируем скроллинг после взаимодействия с изображением
